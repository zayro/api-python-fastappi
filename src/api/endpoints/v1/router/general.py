...
from src.application.v1.controller.generalController import search_controller, search_controllers
...
# SEARCH GENERAL SQL
@general.post("/find", tags=["Consulta"], dependencies=[Depends(validate_current_token)])
...
@general.post("/search", tags=["Consulta"], dependencies=[Depends(validate_current_token)])
